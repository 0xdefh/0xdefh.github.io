...
I'm pretty sure it is not the same page but there are a small connection.

> There is a bias here: the name of the javascript file name could just a file that generated by the phishing kit, the phishing kit could be
...
>
> In this case: From the observation and the content of these script. I could hypothesis these impersonate website generated using the same phishing kit.
{: .prompt-info }


I'll stop here and will post another blog about a case that deep dive into this later.

## Study Case 2: Gmail or Microsoft Outlook

### Collection

Same as the Telegram Login page, we will conduct a quick look at the legit login page of Gmail & Outlook, just to understand how the theat actor would impersonate the legit wesite
...
## Conclusion and my biaes / gap

The techniques to find impersonate website is still a cases by cases. I know that there are plenty of phishing kit, most of them will leave a footprint which you can analyze and create
